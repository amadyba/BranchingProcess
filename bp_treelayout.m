function [x,y,h] = bp_treelayout(Z,post)
%BP_TREELAYOUT Lay out tree or forest.
%   [x,y,h,s] = bp_treelayout(Z,post)
%       Z is the matrix vector of parent pointers (1,:), with 0 for a root.
%           and the generation (2,:), generated by gen_BGW.
...
%
%   In use in my_treeplot and bp_treeplot;

%  04.2016, Amady Ba
%  amady.sba@gmail.com

% This is based on treelayout.m
